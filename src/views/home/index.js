...
export default function Home() {
    const Product = ['Features', 'Pricing', 'Security', 'Updates'];
    const Company = ['About', 'Blog', 'Careers', 'Press'];
    const Resources = ['Documentation', 'Support', 'Terms', 'Privacy'];
                    ...
                    <Inset clip="padding-box" side="top" pb="current">
                        <Flex mt='4' ml='4' mb='4'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                                ...
                                <g clipPath="url(#clipPath3847902615)">
                                     ...
                                     0 4.5 4.2625 4.5 9.5L4.5 14L3 14C1.34375 14 0 15.3438 0 17L0 29C0
                                      30.6562 1.34375 32 3 32L25 32C26.6562 32 28 30.6562 28 29L28 17C28
                                       15.3438 26.6562 14 25 14ZM18.5 14L9.5 14L9.5 9.5C9.5 7.01875 11.5188
                                        ...
                                        fillRule="nonzero" transform="matrix(1 0 0 1 2 0)" fill="rgb(43, 80, 170)"/>
                                </g>
                            </svg>
                            <Text size='4' weight='bold' ml='2' mt='1'>
                                Instant Protection
                    ...
                    <Box width='320px' height='140px' ml='8' mt='8'>
                        <Box  width='100%' align='center'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64">
                                ...
                                <g clipPath="url(#clipPath3573546967)">
                                    <defs>
                                        <clipPath id="clipPath1717931860">
                                            <path d="M0 0L32 0L32 32L0 32L0 0Z" fillRule="nonzero" transform="matrix(1 0 0 1 16 16)"/>
                                        </clipPath>
                                    </defs>
                                    <g clipPath="url(#clipPath1717931860)">
                                        <path d="M25 14L23.5 14L23.5 9.5C23.5 4.2625 19.2375 0 14 0C8.7625 0 4.5 4.2625 4.5 9.5L4.5 14L3 14C1.34375 14 0 15.3438 0 17L0 29C0 30.6562 1.34375 32 3 32L25 32C26.6562 32 28 30.6562 28 29L28 17C28 15.3438 26.6562 14 25 14ZM18.5 14L9.5 14L9.5 9.5C9.5 7.01875 11.5188 5 14 5C16.4813 5 18.5 7.01875 18.5 9.5L18.5 14Z" fillRule="nonzero" transform="matrix(1 0 0 1 18 16)" fill="rgb(255, 255, 255)"/>
                                    </g>
                                </g>
                            </svg>
                        </Box>
            ...
            <Box width='100%' align='center' mt='4' mb='4'>
                ...
                <Flex gap='2' mt='6' mb='8'>
                    <Box width="394px" 
                        ...
                        <Card  asChild size="2" alt='starter' className="hover-card"
                            style={{ 
                                height:'291px',
                                width:'394px',
                            }}>
                    ...
                    <Box width="394px" 
                        ...
                        <Card  asChild size="2" alt='professional' className="hover-card"
                            style={{ 
                                height:'291px',
                                width:'394px',
                                focus: 'outline',
                    ...
                    <Box width="394px" 
                        ...
                        <Card  asChild size="2" alt='enterprise' className="hover-card"
                            style={{ 
                                height:'291px',
                                width:'394px',
                                focus: 'outline',
...
{/* footer for only home page */}
    <Flex width='100%' gap='2'
        ...
        <Section height="400px" />
            ...
            <Box width='280px' height='160px' style={{ marginTop: '75px' }}>
                <Text size='3' weight='bold' ml='2' 
                    style={{
                        color: '#FFFFFF',
                    }}>
                        Product
